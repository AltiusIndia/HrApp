 ...
 */
package cc.altius.hrApplication.utils;
...
public class LogUtils {
    ...
    public static String buildStringForLog(String tag, Exception e) {
    ...
    public static String buildStringForLog(String tag, String sqlString, Map<String, Object> params) {
        ...
        for (Map.Entry<String, Object> tmpEntry : params.entrySet()) {
            if (firstRun) {
                firstRun = false;
    ...
    public static String buildStringForLog(String tag, String sqlString, Object[] params) {
        StringBuilder sb = new StringBuilder(tag).append("','").append(getIpAddress()).append("','").append(getUsername()).append("','").append(StringUtils.escapeQuotes(sqlString)).append(" -- parameters( ");
        boolean firstRun = true;
    ...
    public static String buildStringForLog(String tag, String sqlString, List<Object[]> paramList) {
        StringBuilder sb = new StringBuilder(tag).append("','").append(getIpAddress()).append("','").append(getUsername()).append("','").append(StringUtils.escapeQuotes(sqlString)).append(" -- parameters( ");
        boolean firstRun;
    ...
    public static String buildStringForLog(String tag, String ipAddress, String username, String message) {
    ...
    public static String buildStringForLog(String tag, String message) {
