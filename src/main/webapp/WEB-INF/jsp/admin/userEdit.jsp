        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" modelAttribute="user" method="POST" name="form1" action="../admin/userEdit.htm" id="form1">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <form:input path="emailId" cssClass="form-control" readonly="true"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                              <div class="col-md-3 col-xs-12" style="margin-top: -16px;">
                                                    <form:select path="department.id" cssClass="form-control select" items="${departmentList}" itemLabel="description" itemValue="id"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="req col-md-2 col-xs-12 control-label">Location</label>
                                            <div class="col-md-3 col-xs-12">
                                                <form:select path="location.id" class="select form-control" items="${locationList}" itemLabel="description" itemValue="id"/>
                                            </div>
                                        </div>        
                                        <div class="form-group">
                                            <label class="req col-md-2 col-xs-12 control-label">Role</label>
                                            <div class="col-md-6 col-xs-12">
                                                <form:select path="role.roleId" cssClass="form-control select" items="${roleList}" itemLabel="roleName" itemValue="roleId"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="panel-footer">
                                        <div class="pull-right">
                                            <button type="submit" id="_submit" name="btnSubmit"  class="btn btn-success">Update</button>
