    ...
    <body>
        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content" id="outContainer">
                ...
                <div class="page-content-wrap" >
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form:form cssClass="form-horizontal" modelAttribute="process" method="POST" name="form1" id="form1">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Add Process</h3>
                                    </div>
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <form:select path="location.id" cssClass="form-control select" onchange="updateBuManagerList()">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <form:select path="buManager.userId" cssClass="form-control select">
                                                    <form:option value="" label="Please select"/>
        ...
        <script type="text/javascript">
            ...
            function updateBuManagerList() {
                ...
                $buDropDown.append($("<option value=''></option>"));
            <c:forEach items="${buManagerList}" var="bu">
                if (locationId == '${bu.id}') {
                    $buDropDown.append($("<option value='${bu.userId}'>${bu.name}</option>"));
                }
            </c:forEach>
                $buDropDown.val("").selectpicker('refresh');
            }
        </script>
