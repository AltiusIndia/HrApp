        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content" id="outContainer">
                ...
                <div class="page-content-wrap" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" modelAttribute="requisition" method="POST" name="form1" id="form1">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <form:select path="location.id" cssClass="form-control select">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-xs-12">
                                                <form:select path="department.id" cssClass="form-control select">
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="process.id" cssClass="form-control select select-field-padding">
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="buManager.userId" cssClass="form-control select select-field-padding">
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="processCategory.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="employmentType.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="recruitmentType.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="recruitmentLevel.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:input path="hiringCount"  cssClass="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="req col-md-3 col-xs-12 control-label">Languages</label>
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="languageIds" cssClass="form-control select select-field-padding" multiple="true" items="${languageList}" itemValue="id" itemLabel="description"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="req col-md-3 col-xs-12 control-label">Training start date </label>
                                            <div class="col-md-4  col-xs-12"> 
                                                <form:input path="trainingStartDate" class="form-control" autocomplete="off"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="minQualification.id" cssClass="form-control select select-field-padding">
                                                    <form:option value="" label="Nothing selected"/>
                                                    <form:options items="${minQualificationList}" itemLabel="description" itemValue="id"/>
                                                </form:select>
                                            </div>
                                        </div> 
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="typingSpeed.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="communicationProficiency.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="genderRatio.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:textarea path="operationsWindow" cssClass="form-control"/>
                                            </div>
                                        </div>  
                                        <div class="form-group">
                                            <label class="req col-md-3 col-xs-12 control-label">Week-off pattern</label>
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="weekOffPattern.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="weekOffCount.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="shiftDuration.id" cssClass="form-control select select-field-padding" >
                                                    <form:option value="" label="Nothing selected"/>
        ...
        <script type="text/javascript">
            var jvalidate = $("#form1").validate({
                ...
                rules: {
                    ...
                    'buManager.userId': {required: true},
                    'processCategory.id': {required: true},
                    'employmentType.id': {required: true},
                    'recruitmentType.id': {required: true},
                    'recruitmentLevel.id': {required: true},
                    'hiringCount': {required: true, min: 1, max: 100},
                    'genderRatio.id': {required: true},
                    'salaryBand': {required: true},
                    'operationWindow': {required: true},
                    'weekOffPattern.id': {required: true},
                    'weekOffCount.id': {required: true},
                    'shiftDuration,id': {required: true},
                    'trainingStartDate': {required: true},
                    'languageProficiency': {required: true},
                    'typingSpeed.id': {required: true},
                    'communicationProficiency.id': {required: true},
                    'comments': {required: true},
                    'shiftDuration.id': {required: true},
                    'operationsWindow': {required: true},
                    'minQualification.id': {required: true},
                    'languageIds': {required: true}
                },
