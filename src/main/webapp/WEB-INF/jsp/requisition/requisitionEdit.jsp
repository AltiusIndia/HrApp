        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content" id="outContainer">
                ...
                <ul class="breadcrumb">
                    ...
                    <li><a href="#">Edit Requisition</a></li>
                </ul>
                <!-- END BREADCRUMB --> 
                ...
                <div class="page-content-wrap" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" modelAttribute="requisition" method="POST" name="form1" id="form1" action="../requisition/requisitionEdit.htm">
                                <form:hidden path="requisitionId"/>
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:select path="languageIds" cssClass="form-control select select-field-padding" multiple="true" items="${languageList}" itemLabel="description" itemValue="id"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4  col-xs-12">
                                                <form:textarea path="hrComments"  cssClass="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="req col-md-3 col-xs-12 control-label">HR Buffer count</label>
                                            <div class="col-md-4  col-xs-12">
                                                <form:input path="hrBufferCount" cssClass="form-control"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="req col-md-3 col-xs-12 control-label">HR closing date </label>
                                            <div class="col-md-4  col-xs-12"> 
                                                <form:input path="hrClosingDate" class="form-control" autocomplete="off"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="req col-md-3 col-xs-12 control-label">Status</label>
                                            <div class="col-md-4  col-xs-12"> 
                                                <form:select path="status.id" class="form-control select select-field-padding" items="${requisitionStatusList}" itemLabel="description" itemValue="id"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
        ...
        <script type="text/javascript">
            var jvalidate = $("#form1").validate({
                ...
                rules: {
                    ...
                    'hrComments': {required: true},
                    'hrBufferCount': {required: true},
                    'hrClosingDate': {required: true}
                },
